                ...
                <?php   
                   ...
                   if (mysqli_num_rows($res) > 0) {
                    ...
                    <tr>
                        ...
                        <td><a href="?sdm=makeup_model&id_vendor_makeup=<?php echo $row['id_vendor_makeup'] ?>&method=edit"><?php echo $no ?></a></td>
                        ...
                        <td><a href="?sdm=makeup_model&id_vendor_makeup=<?php echo $row['id_vendor_makeup'] ?>&method=delete"><b>Delete</b></a></td>
