            ...
            <?php
               ...
               if (mysqli_num_rows($res) > 0) {
                ...
                while($row = mysqli_fetch_assoc($res)) {
                     ?>     
                <tr>
                    <td><a href="?sdm=catering_model&id_vendor_catering=<?php echo $row['id_vendor_catering'] ?>&method=edit"><?php echo $no ?></a></td>
                    <td><?php echo $row["name"] ?></td>
                    <td><?php echo $row["phone_number"] ?></td>
                    <td><?php echo $row["address"] ?></td>             
                    <td><a href="?sdm=catering_model&id_vendor_catering=<?php echo $row['id_vendor_catering'] ?>&method=delete"><b>Delete</b></a></td>
                </tr>
